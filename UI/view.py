...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnCompConnessa = ft.ElevatedButton(text="Cerca Connessa",
                                                  on_click=self._controller.handleCompConnessa,
                                                  bgcolor="orange",
                                                  color="white",
                                                  width=200,
                                                  disabled= True)    # li disabilito fino a quando non ho creato il grafo
